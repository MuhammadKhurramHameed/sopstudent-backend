...
$base = "http://127.0.0.1:8000" . $script_name;
$base1 = $base;
...
define('URL_QUIZ_PREREQUIRMENTS', PREFIX.'exams-pre/quiz/pre-requisites');
...
define('URL_TOPICS_PREREQUIRMENTS', PREFIX.'mastersettings/topics/pre-requisites');
...
define('URL_STUDENTS_EDIT', PREFIX.'students/edit/');
...
define('URL_EXAM_SERIES_PREREQUIRMENTS', PREFIX.'exams/exam-series/pre-requisites');
...
define('URL_LMS_CONTENT_PREREQUIRMENTS', PREFIX.'lms/content/pre-requisites');
//LMS SERIES
...
define('URL_FAQ_QUESTIONS_PREREQUIRMENTS', PREFIX.'faq-question/pre-requisites');
//FRONT FAQS
